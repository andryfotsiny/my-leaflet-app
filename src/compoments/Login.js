...
Bienvenue sur la cartographie interactive des crimes et de l'insécurité à Fianarantsoa. Cette plateforme vise
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-y-4 gap-x-6">
              ...
              >
                <span className="relative text-base font-semibold text-black">connecter avec google pour acceder au map </span>
              </p>
              <a
            ...
            <div className="hidden py-8 mt-16 border-y border-gray-100 dark:border-gray-800 sm:flex justify-between">
              <div className="text-left">
                ...
                <p className="mt-2 text-gray-800 ">Visualisez les incidents criminels sur une carte dynamique.<br />
Filtrez les incidents par type de crime, date, et lieu.<br />
Cliquez sur les marqueurs pour obtenir des détails sur chaque incident.</p>
              </div>
              <div className="text-left">
                <h6 className="text-lg font-semibold text-gray-700 dark:text-gray-800 font-bold">Donnée</h6>
                <p className="mt-2 text-gray-800">tableau de crimes et de fonctionnalité de recherche pour la trié le donnée de la tableau</p>
              </div>
              <div className="text-left">
                <h6 className="text-lg font-semibold text-gray-700 dark:text-gray-800 font-bold">Staitistique</h6>
                <p className="mt-2 text-gray-800">Accédez à des statistiques détaillées sur les types de crimes les plus fréquents.<br/>
Analysez les tendances mensuelles et annuelles.</p>
              </div>
            </div>
          </div>
